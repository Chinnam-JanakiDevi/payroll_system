...
//         pdf.setFontSize(16);
//         pdf.text('Salary Details', startX, startY);
...
//         // Define table data
//         const GrossDetails = [
//             [{ content: 'Gross Details', colSpan: 2, styles: { fillColor: [0, 102, 204], textColor: [255, 255, 255], fontStyle: 'bold', halign: 'center' } }],
...
//             [{ content: 'Gross Deductions', colSpan: 2, styles: { fillColor: [0, 102, 204], textColor: [255, 255, 255], fontStyle: 'bold', halign: 'center' } }],
...
//         const MainDetails = [
//             [{ content: 'Employee Details', colSpan: 2, styles: { fillColor: [0, 102, 204], textColor: [255, 255, 255], fontStyle: 'bold', halign: 'center' } }],
//             ['Employee Name', employeeDetails[19]],
//             ['Employee Code', employeeDetails[2]],
//             ['Salary Month', employeeDetails[0]],
//         ];

//         // Draw the first table (MainDetails)
//         pdf.autoTable({
...
//         // Adjust startX for the next tables
//         startX = 20;

//         // Draw the second table (GrossDetails)
//         pdf.autoTable({
//             startY: pdf.autoTable.previous.finalY + 5,
//             body: GrossDetails,
//             theme: 'plain',
...
//                 lineWidth: 0.1,
//             },
//             startX: startX, // Set the startX position
//         });

//         // Update startX for the next table
//         startX = pdf.autoTable.previous.finalX + 10;

//         // Draw the third table (GrossDeductions)
//         pdf.autoTable({
//             startY: pdf.autoTable.previous.finalY + 5,
//             body: GrossDeductions,
//             theme: 'plain',
//             styles: {
//                 cellPadding: 2,
//                 fontSize: 10, // Adjust font size
